<?php
// INSERT INTO `notes` (`sno`, `name`, `lname`, `country`,`tstamp`) VALUES (NULL, 'But Books', 'Please buy Books from store', current_timestamp());
$insert = false;
$update = false;
$delete = false;
...
if (isset($_POST['snoEdit'])){
  ...
  $sql = "UPDATE `form` SET `name` = '$name' , `lname` = '$lname' , `country` = '$country' WHERE `form`.`sno` = $sno";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
  }
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `form` (`name`, `lname`, `country`) VALUES ('$name', '$lname', '$country')";
  $result = mysqli_query($conn, $sql);
        ...
        <form action="/form/index.php" method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="countryEdit" name="countryEdit" aria-describedby="emailHelp">
            </div>

            <!-- <div class="form-group form-group-prepend mb-3">
  ...
  <script>
    ...
    Array.from(edits).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        console.log(name, lname, country);
        nameEdit.value = name;
